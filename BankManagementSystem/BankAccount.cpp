...
int BankAccount::getLastAccountNumber() {
...
void BankAccount::incrementAccountNumber() {
    int lastAccountNumber = BankAccount::getLastAccountNumber();
...
int BankAccount::getCurrentAccounts() {
    ...
    for (auto entry : filesystem::recursive_directory_iterator("Users/")) {
        if (filesystem::is_directory(entry.path())) {
            currentAccounts++;
        }
    }

    totalAccounts = currentAccounts;
