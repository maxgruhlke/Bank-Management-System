...
string bankAccount() {
    ...
    do {
       ...
       */   
        ...
        cout << "Account type : " << x.getAccountType() << endl;
        cout << "Account number : " << x.getAccountNumber() << endl;
        cout << "Account balance : $" << x.getAccountBalance() << endl;

        BankAccount z = BankAccount(user->getUsername(), 1);
        cout << "Account type : " << z.getAccountType() << endl;
        cout << "Account number : " << z.getAccountNumber() << endl;
        cout << "Account balance : $" << z.getAccountBalance() << endl;
